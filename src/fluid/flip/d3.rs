...
use crate::fluid::obstacle::{Obstacle3D, ObstacleSet3D};
...
impl FlipFluid3D {
    ...
    fn handle_particle_collisions(&mut self, obstacles: &ObstacleSet3D, dt: f32) {
    ...
    pub fn set_obstacles(&mut self, obstacles: &ObstacleSet3D, dt: f32) {
