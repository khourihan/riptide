...
use crate::fluid::{obstacle::{Obstacle, ObstacleSet}, Fluid};
...
impl Fluid<3> for FlipFluid3D {
    ...
    fn encode_state<W: std::io::Write>(&self, encoder: &mut crate::io::encode::FluidDataEncoder<W>) -> Result<(), crate::io::encode::EncodingError> {
